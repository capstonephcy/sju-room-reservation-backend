...
public class EmailService {
    ...
    private MimeMessage createVerificationMessage(String to) throws Exception{
        ...
        message.setSubject("세종대학교 회의실 예약 서비스 비밀번호 찾기 인증 코드: " + currentAuthCode); //제목

        String verificationMessage="";
        verificationMessage += "<div style=\"padding-right: 30px; padding-left: 30px; margin: 10px 0 10px;\"><img src=\"https://avatars.githubusercontent.com/u/127483660?s=200&v=4\" width=\"60px\" height=\"60px\" loading=\"lazy\"></div>";
        ...
        verificationMessage += "<p style=\"font-size: 17px; padding-right: 30px; padding-left: 30px;\">아래 확인 코드를 인증코드 입력란에 입력하십시오.</p>";
        ...
        verificationMessage += "<p style=\"font-size: 17px; padding-right: 30px; padding-left: 30px;\">확인 코드는 회의실 예약 서비스의 비밀번호 찾기에 사용되므로, 만약, 본인이 요청한 것이 아니라면 본 이메일을 무시하십시오.</p><br/>";
        verificationMessage += "<div style=\"border-bottom: 0.5px solid gray; padding-right: 30px; padding-left: 30px; margin: 10px 30px 10px 30px;\"></div>";
        verificationMessage += "<p style=\"font-size: 13px; color: gray; padding-right: 30px; padding-left: 30px;\">본 이메일은 발신전용입니다.</p>";
        verificationMessage += "<p style=\"font-size: 13px; color: gray; padding-right: 30px; padding-left: 30px;\">P.H.C.Y. All Rights Reserved.</p><br/>";

        message.setText(verificationMessage, "utf-8", "html"); //내용
        message.setFrom(new InternetAddress("ph2ydev@gmail.com","P.H.C.Y.")); //보내는 사람
    ...
    private MimeMessage createTempPasswordNotifyMessage(String to, String tempPassword) throws Exception{
        ...
        message.addRecipients(Message.RecipientType.TO, to); //보내는 대상
        message.setSubject("세종대학교 회의실 예약 서비스 비밀번호 찾기: 임시 비밀번호 통지"); //제목

        String tempPasswordNotifyMessage="";
        tempPasswordNotifyMessage += "<div style=\"padding-right: 30px; padding-left: 30px; margin: 10px 0 10px;\"><img src=\"https://avatars.githubusercontent.com/u/127483660?s=200&v=4\" width=\"60px\" height=\"60px\" loading=\"lazy\"></div>";
        ...
        tempPasswordNotifyMessage += "<p style=\"font-size: 13px; color: gray; padding-right: 30px; padding-left: 30px;\">P.H.C.Y. All Rights Reserved.</p><br/>";
